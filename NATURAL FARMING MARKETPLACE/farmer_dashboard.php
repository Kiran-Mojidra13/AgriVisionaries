    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link" href="index.php"><i class="fas fa-home"></i> <?php echo $texts['home']; ?></a></li>
                <li class="nav-item"><a class="nav-link" href="add_product.php"><i class="fas fa-plus-circle"></i> <?php echo $texts['add_product']; ?></a></li>
                <li class="nav-item"><a class="nav-link" href="subcategory_add.php"><i class="fas fa-list"></i> <?php echo $texts['add_sub_category']; ?></a></li>
                <li class="nav-item"><a class="nav-link" href="view_orders.php"><i class="fas fa-box"></i> <?php echo $texts['view_orders']; ?></a></li>
                <li class="nav-item"><a class="nav-link" href="view_reviews.php"><i class="fas fa-star"></i> <?php echo $texts['view_reviews']; ?></a></li>
                <!-- <li class="nav-item"><a class="nav-link" href="my_products.php"><i class="fas fa-cogs"></i> <?php echo $texts['my_products']; ?></a></li> -->
            </ul>
            <ul class="navbar-nav me-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center px-2 me-2" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown">
                        <i class="fas fa-user-circle me-1"></i> 
                        <span><?php echo htmlspecialchars($farmer['full_name']); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="update_profile.php"><i class="fas fa-user-edit"></i> <?php echo $texts['update_profile']; ?></a></li>
                        <li><a class="dropdown-item text-danger" href="logout.php"><i class="fas fa-sign-out-alt"></i> <?php echo $texts['logout']; ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <?php foreach ($categories as $category): ?>
            <div class="col-md-4 mb-4">
                <div class="category-card">
                    <!-- Category Image -->
                    <img src="uploads/<?php echo htmlspecialchars($category['category_image']); ?>" alt="<?php echo htmlspecialchars($category['category_name']); ?>">
                    <div class="card-body">
                        <!-- Category Name -->
